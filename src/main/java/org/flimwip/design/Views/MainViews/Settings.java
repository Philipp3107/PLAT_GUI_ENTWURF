...
public class Settings extends VBox {
    ...
    private void init(){
        ...
        this.getChildren().addAll(app_user_setting, user_settings);
    ...
    private VBox buidl_app_user_settings(){
        ...
        Label first = new Label(au.get_first_name());
        Label second = new Label(au.get_last_name());
        first.setStyle("-fx-text-fill: white; -fx-font-size: 15");
        second.setStyle("-fx-text-fill: white; -fx-font-size: 15");
        HBox name_h = new HBox(10, first, second);
        name.getChildren().addAll(l, name_h);
        box.getChildren().addAll(heading, name);
        return box;
    }
