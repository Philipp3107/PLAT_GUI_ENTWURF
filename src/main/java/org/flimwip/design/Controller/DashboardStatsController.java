 ...
 */
@ServiceC(desc = "This Controller controls the Statistics on the Dashboard", related={"Dashboard"})
public class DashboardStatsController {

    /**
     * The Dashboard this controller belongs to
     */
    @ServiceATT(desc = "The Dashboard this controller belongs to",
                type = "Dashboard")
     ...
     */
    @ServiceATT(desc = "All Dashboard Buttons that are needed to controll the Stats on the Dashboard",
     ...
     */
    @ServiceCR(desc = "Constructor of the DasboardStatsController class",
               params = {"Dashbaord dashboard -> Dashboard this controller belongs to"},
               related={"Dashboard"})
    ...
    @ServiceM(desc = "The DashboardButton that switch the Stats on the Dashboard between WARN, ERROR and CRITICAL",
              category = "Setter",
              params = {"error DashboardButton", "warn DashboardButton", "critical DashboardButton"},
              returns = "void",
              thrown = {"None"},
              related = {"DashboardButton"})
     ...
     */
    @ServiceM(desc = "Once a DashboardButton is pressed, the focus of the other DashboardButton gets taken away. So Only one DashboardButton is selected at a item.",
              category = "Method",
              params = {"String button_id -> ID of the DashboardButton"},
              returns = "void",
              thrown = {"None"},
              related = {"DashboardButton"})
     ...
     */
    @ServiceM(desc = "Changes the Stats on the Dashboard to the given category",
              category = "Method",
              params = {"String category -> The Category the Stats will be set to. Possible categories are \"error\", \"warn\" and \"critical\""},
              returns = "void",
              thrown = {"None"},
              related = {"Dashboard"})
